...
Questo è l'esempio di un modulo di pagamento di base per l'articolo [Come strutturare un modulo HTML](/it/docs/Learn_web_development/Extensions/Forms/How_to_structure_a_web_form).
