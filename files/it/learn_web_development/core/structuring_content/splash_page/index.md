---
title: "Sfida: Pagina iniziale sui piccoli animali striscianti"
short-title: "Sfida: Pagina iniziale"
...
In questa sfida, verrà verificata la conoscenza di alcune delle tecniche trattate nelle ultime lezioni, aggiungendo immagini e un video a una pagina iniziale dedicata agli insetti e ad altri piccoli animali striscianti.
...
1. Creare una nuova cartella in una posizione appropriata sul computer chiamata `splash-page-challenge` (oppure aprire un editor online e seguire i passaggi necessari per creare un nuovo progetto).
2. Salvare il seguente elenco HTML in un file nella cartella chiamato `index.html` (oppure incollarlo nel riquadro HTML dell'editor online).
...
3. Salvare il seguente elenco CSS in un file nella cartella chiamato `style.css` (oppure incollarlo nel riquadro CSS dell'editor online).
...
Successivamente, sarà necessario includere nella pagina i seguenti URL.

- `bee.jpg`: [Immagine per la sezione "Api, vespe, formiche (Hymenoptera)"](https://mdn.github.io/shared-assets/images/examples/learn/crawlies/bee.jpg).
- `beetle.png`: [Immagine per la sezione "Coleotteri (Coleoptera)"](https://mdn.github.io/shared-assets/images/examples/learn/crawlies/beetle.png).
- `butterfly.jpg`: [Immagine per la sezione "Farfalle e falene (Lepidoptera)"](https://mdn.github.io/shared-assets/images/examples/learn/crawlies/butterfly.jpg).
- `fly.jpg`: [Immagine per la sezione "Mosche e zanzare (Diptera)"](https://mdn.github.io/shared-assets/images/examples/learn/crawlies/fly.jpg).
- `spider.jpg`: [Immagine per la sezione "Ragni (Araneae)"](https://mdn.github.io/shared-assets/images/examples/learn/crawlies/spider.jpg).
- `true_bug.jpg`: [Immagine per la sezione "Cimici vere (Hemiptera)"](https://mdn.github.io/shared-assets/images/examples/learn/crawlies/true_bug.jpg).
- `bug_video_640.mp4`: [video dell'intestazione](https://mdn.github.io/shared-assets/videos/learn/bug_video_640.mp4).

## Descrizione del progetto

In questa verifica viene presentata una pagina iniziale quasi completata dedicata a diversi piccoli animali striscianti. Purtroppo, non sono ancora state aggiunte immagini o video: questo è il compito da svolgere. Occorre aggiungere contenuti multimediali per rendere la pagina più interessante. Le sottosezioni seguenti descrivono nel dettaglio cosa fare.

### Aggiungere un video all'intestazione

Subito sotto `<h1>`, aggiungere un elemento `<video>` che incorpori nella pagina il video dell'intestazione. Il video deve avere le seguenti caratteristiche:

- Avviarsi automaticamente al caricamento (affinché questo funzioni almeno in alcuni browser, occorre anche specificare che il video deve essere silenziato).
- Ripetersi continuamente invece di essere riprodotto una sola volta.
- Precaricare il contenuto video.
- Non mostrare alcun controllo.

### Aggiungere immagini alle sezioni

Nelle sezioni informative espanse relative a ciascun tipo di insetto, sotto ogni `<h2>`, aggiungere un elemento immagine che incorpori l'immagine appropriata per ciascuna sezione. Assegnare a ogni immagine un testo alternativo appropriato, a vantaggio degli utenti di screen reader e nel caso in cui l'immagine non venga caricata, e limitare ogni immagine a dimensioni di 250 x 180.

Inoltre, includere una didascalia per ogni immagine; occorre riflettere su quale elemento contenitore sia necessario per associare semanticamente i due elementi. La didascalia non deve limitarsi a ripetere il testo alternativo: deve funzionare insieme al testo alternativo e all'immagine.

### Aggiungere emoji o icone di insetti al menu di navigazione e agli `<h2>`

Per un tocco di divertimento, aggiungere icone all'inizio di ogni elemento dell'elenco di navigazione e la stessa icona all'inizio di ogni `<h2>` corrispondente. Questo si potrebbe fare usando immagini incorporate, ma è più semplice cercare emoji appropriate e aggiungerle direttamente al testo HTML.

## Suggerimenti

- È possibile usare il [validatore HTML del W3C](https://validator.w3.org/) per individuare eventuali errori nell'HTML.
- Non è necessario conoscere alcun CSS per svolgere questa verifica; è sufficiente modificare il file HTML fornito. La parte CSS è già stata realizzata.

## Esempio

La seguente schermata mostra l'aspetto che dovrebbe avere la pagina iniziale. Se risulta difficile capire come ottenere alcuni di questi risultati, consultare la soluzione sotto l'esempio live.

![La nostra pagina iniziale di esempio](finished-splash-example.png)
