...
`header-test.js` è per scrivere test automatici per garantire che la nostra app continui a funzionare nel tempo man mano che aggiorniamo, aggiungiamo funzionalità, refattoriamo, ecc. Il testing è fuori dal campo di questo tutorial, anche se generalmente dovrebbe essere implementato mentre si sviluppa, piuttosto che dopo, altrimenti tenderebbe ad essere dimenticato. Se sei curioso riguardo al testing, o perché si vorrebbero avere test automatici, dai un'occhiata al [tutorial ufficiale di Ember sul testing](https://guides.emberjs.com/release/tutorial/part-1/automated-testing/).
